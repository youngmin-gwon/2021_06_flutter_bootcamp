...
class AnimatedPhysicalModelPracticePage extends StatefulWidget {
  const AnimatedPhysicalModelPracticePage({Key? key}) : super(key: key);

  @override
  _AnimatedPhysicalModelPracticePageState createState() =>
      _AnimatedPhysicalModelPracticePageState();
}

class _AnimatedPhysicalModelPracticePageState
    extends State<AnimatedPhysicalModelPracticePage> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        DemoButton(onPressed: _changeState, label: "Animate")
      ],
    );
  }
}
